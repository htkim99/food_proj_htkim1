<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="Orderno" v-model="item.orderno" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Storecode" v-model="item.storecode" :editMode="editMode" @change="change" />
            </div>
            <div>
